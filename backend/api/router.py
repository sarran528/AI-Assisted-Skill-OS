...
api_router.include_router(profiling_router, prefix="/profile", tags=["profile"], dependencies=[Depends(get_current_user)])
api_router.include_router(skill_router, prefix="/skill", tags=["skill"], dependencies=[Depends(get_current_user)])
api_router.include_router(roadmap_router, prefix="/roadmap", tags=["roadmap"], dependencies=[Depends(get_current_user)])
api_router.include_router(session_router, prefix="/session", tags=["session"], dependencies=[Depends(get_current_user)])
api_router.include_router(evidence_router, prefix="/evidence", tags=["evidence"], dependencies=[Depends(get_current_user)])
api_router.include_router(validation_router, prefix="/checkpoint", tags=["checkpoint"], dependencies=[Depends(get_current_user)])
api_router.include_router(support_router, prefix="", tags=["support"], dependencies=[Depends(get_current_user)])
