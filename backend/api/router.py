...
from backend.tip.router import router as tip_router
...
api_router.include_router(support_router, prefix="/support", tags=["support"], dependencies=[Depends(get_current_user)])
api_router.include_router(tip_router, prefix="/tip", tags=["tip"], dependencies=[Depends(get_current_user)])
